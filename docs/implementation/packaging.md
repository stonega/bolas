...
Outputs for version 0.1.5 are `dist/bolas_0.1.5_all.deb`,
`dist/bolas-0.1.5-1.noarch.rpm`, and `dist/SHA256SUMS`. Each build uses a fresh
...
```sh
bash scripts/package.sh v0.1.5
```
